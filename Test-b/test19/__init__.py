...
if 变量1 != '1':
                                    ...
                                    if SHOUQIANG:
                                        ...
                                        if 变量9 == '本茨·拉登':
                                            ...
                                            if 变量10 == '1':
                                                ...
                                                time.sleep(random.randint(1, 2))
                                                print(
                                                    '后记：你加入了狼群，被改造成了狼人，并成为了新的首领，成为了大名鼎鼎的狼王' + 变量 + ',')
                                                time.sleep(random.randint(1, 2))
                                                print('    村子里的人对你深恶痛绝。')
                                                time.sleep(random.randint(1, 2))
    ...
    time.sleep(random.randint(1, 2))
    print(
        '你在野外前进，发现了一个人，他自我介绍说他叫莱奥，是个屠狼师，你也自报家门说，我叫' + 变量 + ',他果断要求加入你的队伍，')
        ...
        if HUOBAN:
            ...
            if 变量17 == '1':
                ...
                if 变量18 == '1':
                    ...
                    time.sleep(random.randint(1, 2))
                    print(
                        '后记：你以一己之力杀死了所有的狼人这一行为被整个村庄追捧，甚至其余地方的狼人听见' + 变量 + '这一名字都胆战心惊，再不敢来犯。')
                    time.sleep(random.randint(1, 2))
                    print('剧情5完结——')
                    time.sleep(random.randint(1, 2))
                    print('游戏结束——')
