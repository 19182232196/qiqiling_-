...
def main():
    ...
    pygame.init()     # 初始化游戏环境
    screen = pygame.display.set_mode((590,590),0,0)          # 创建游戏窗口 # 第一个参数是元组：窗口的长和宽
    pygame.display.set_caption("老手er五子棋")                # 添加游戏标题
    background = pygame.image.load("images/bg.jpg")          #加载背景图片
    whiteStorn = pygame.image.load("images/bai.png") #加载白棋图片
    blackStorn = pygame.image.load("images/hei.png") #加载黑棋图片
    resultStorn = pygame.image.load("images/win.jpg")#加载 赢 时的图片
