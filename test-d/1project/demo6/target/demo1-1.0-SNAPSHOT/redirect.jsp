...
<body>
        ...
        <!--打印取到的数据-->
        重定向的页面取page域中的数据：<font color="red"><%=pageMsg%></font><hr><br/>

        重定向的页面取request域中的数据：<font color="red"><%=requestMsg%></font><hr><br/>

        重定向的页面取session域中的数据：<font color="red"><%=sessionMsg%></font><hr><br/>

        重定向的页面取application域中的数据：<font color="red"><%=applicationMsg%></font><hr><br/>
</body>
</html>
