        ...
        <div class="data_form">
            <table align="center">
                ...
                <tr>
                    ...
                    <td><input type="date" id="userBirthday" name="userBirthday" style="margin-top:5px;height:30px;"/></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><input type="text" id="nikeName" name="userOtherName" placeholder="某科老师/学生" style="margin-top:5px;height:30px;"/></td>
